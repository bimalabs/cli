...
func (c *Container) SafeGetBimaGeneratorDic() (*generators.Dic, error) {
	...
	if err != nil {
		var eo *generators.Dic
		return eo, err
	}
	o, ok := i.(*generators.Dic)
	if !ok {
		return o, errors.New("could get 'bima:generator:dic' because the object could not be cast to *generators.Dic")
	}
	return o, nil
}
...
func (c *Container) SafeGetBimaGeneratorModel() (*generators.Model, error) {
	...
	if err != nil {
		var eo *generators.Model
		return eo, err
	}
	o, ok := i.(*generators.Model)
	if !ok {
		return o, errors.New("could get 'bima:generator:model' because the object could not be cast to *generators.Model")
	}
	return o, nil
}
...
func (c *Container) SafeGetBimaGeneratorModule() (*generators.Module, error) {
	...
	if err != nil {
		var eo *generators.Module
		return eo, err
	}
	o, ok := i.(*generators.Module)
	if !ok {
		return o, errors.New("could get 'bima:generator:module' because the object could not be cast to *generators.Module")
	}
	return o, nil
}
...
func (c *Container) SafeGetBimaGeneratorProto() (*generators.Proto, error) {
	...
	if err != nil {
		var eo *generators.Proto
		return eo, err
	}
	o, ok := i.(*generators.Proto)
	if !ok {
		return o, errors.New("could get 'bima:generator:proto' because the object could not be cast to *generators.Proto")
	}
	return o, nil
}
...
func (c *Container) SafeGetBimaGeneratorProvider() (*generators.Provider, error) {
	...
	if err != nil {
		var eo *generators.Provider
		return eo, err
	}
	o, ok := i.(*generators.Provider)
	if !ok {
		return o, errors.New("could get 'bima:generator:provider' because the object could not be cast to *generators.Provider")
	}
	return o, nil
}
...
func (c *Container) SafeGetBimaGeneratorServer() (*generators.Server, error) {
	...
	if err != nil {
		var eo *generators.Server
		return eo, err
	}
	o, ok := i.(*generators.Server)
	if !ok {
		return o, errors.New("could get 'bima:generator:server' because the object could not be cast to *generators.Server")
	}
	return o, nil
}
...
func (c *Container) SafeGetBimaGeneratorSwagger() (*generators.Swagger, error) {
	...
	if err != nil {
		var eo *generators.Swagger
		return eo, err
	}
	o, ok := i.(*generators.Swagger)
	if !ok {
		return o, errors.New("could get 'bima:generator:swagger' because the object could not be cast to *generators.Swagger")
	}
	return o, nil
}
...
func (c *Container) SafeGetBimaModuleGenerator() (*generators.Factory, error) {
	...
	o, ok := i.(*generators.Factory)
	if !ok {
		return o, errors.New("could get 'bima:module:generator' because the object could not be cast to *generators.Factory")
	}
	return o, nil
}
